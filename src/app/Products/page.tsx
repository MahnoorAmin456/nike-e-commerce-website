    ...
    const fetchProducts = async () => {
        try {
            ...
            *[type == "product"] {
            ...
            description,
            discountPercentage,
            "imageUrl": <productImage className="assest-">url,
            tags
        }
            `;
       ...
       const truncateDescription = (description: string) => {
        ...
        return(
            <div className="p-4">
                <h2 className="text-center text-slate-800 mt-4 mb-4"> ProductsFrom API's Data</h2>
               ...
               <div className="mt-4">
                ...
                <button className="mt-4 w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700"onClick={() => addtoCart(product)}>
